...
export const landingData = {
  ...
  gallery: {
    ...
    items: [
      {
        src: "/images/gallery-ambiente.svg",
        alt: "Ambiente interno sofisticado do Zin Bar e Restaurante",
        title: "Salão principal",
        caption: "Clima acolhedor, iluminação quente e mesas confortáveis.",
        layout: "featured" as GalleryLayout,
      },
      {
        src: "/images/gallery-drinks.svg",
        alt: "Drinks do happy hour do Zin Bar e Restaurante",
        title: "Drinks do happy hour",
        caption: "Boa execução e apresentação que valoriza o encontro.",
        layout: "square" as GalleryLayout,
      },
      {
        src: "/images/gallery-prato.svg",
        alt: "Prato principal servido no Zin Bar e Restaurante",
        title: "Pratos bem apresentados",
        caption: "Opções para almoço e jantar com visual e sabor equilibrados.",
        layout: "wide" as GalleryLayout,
      },
      {
        src: "/images/gallery-familia.svg",
        alt: "Mesa confortável para família e amigos no Zin Bar",
        title: "Mesas para reunir",
        caption: "Espaço pensado para família, casais e grupos de amigos.",
        layout: "tall" as GalleryLayout,
      },
      {
        src: "/images/gallery-happyhour.svg",
        alt: "Clima de happy hour no Zin Bar e Restaurante",
        title: "Fim de tarde no Zin Bar",
        caption: "O ritmo certo para prolongar a conversa.",
        layout: "square" as GalleryLayout,
      },
      {
        src: "/images/gallery-petfriendly.svg",
        alt: "Área acolhedora e pet friendly do Zin Bar",
        title: "Conforto com liberdade",
        caption: "Uma casa que recebe bem diferentes estilos de visita.",
        layout: "square" as GalleryLayout,
      },
    ],
  },
